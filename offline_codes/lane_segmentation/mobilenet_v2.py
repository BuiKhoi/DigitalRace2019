...
def MobileNetv2(input_shape, k, alpha=1.0):
    ...
    x = _inverted_residual_block(x, 64, (3, 3), t=2, alpha=alpha, strides=1, n=3)
    x = _inverted_residual_block(x, 128, (3, 3), t=2, alpha=alpha, strides=2, n=3)
    ...
    x = _conv_block(x, 1, (1, 1), strides=(1, 1))
